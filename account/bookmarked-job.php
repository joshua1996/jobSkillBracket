...
<body class="page page-id-12 page-template-default logged-in jobplanet wpb-js-composer js-comp-ver-4.9.1 vc_responsive">
        ...
        Create Job Alert    </a>
                    ...
                    <div class="col-md-9 col-sm-9">
                        <div class="block-section box-side-account">
                            ...
                            <h3 class="no-margin-top">Bookmarked Job</h3>
                            <p><strong>Note :</strong> Easier to access your favorite job in future</p>
                            <hr>
                            <div class="table-responsive">
                                <div class="alert alert-info fade in" role="alert">
                                    You have not bookmark any jobs yet </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        var woocommerce_params = {
            ...
            "wc_ajax_url": "\/account\/bookmarked-job\/?wc-ajax=%%endpoint%%"
        };
        /* ]]> */
    </script>
