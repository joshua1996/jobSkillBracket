...
$company = "select * from company where userID='".$_SESSION[ 'userID']."'";
...
$a=' limit ' .$start. ','.$limit. ''; 
 $pageResult=mysqli_query($conn,$company.$a); 

if(isset($_POST['Delete'])){
	$deleleCompany = "delete  from company where id='".$_POST['company_id']."'";
	if(mysqli_query($conn,$deleleCompany)){
		echo 'true';
	} else{
		echo mysqli_error($conn);
	}
//	echo "delete from company where id='".$_POST['company_id']."'";
}
?>
<html>
        ...
        Create Company    </a>
                    ...
                    <div class="col-md-9 col-sm-9">
                        <div class="block-section box-side-account">
                            ...
                            <h3 class="no-margin-top">Company List</h3>
                            <p><strong>Note :</strong> Company that you been created previously</p>
                            <hr>
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="http://localhost:8080/jobSkillBracket/company.php?company=<?php echo $column[0]; ?>" target="_blank"><?php echo $column[1]; ?></a></td>
                                            <td class="text-right">
                                                <a class="btn btn-theme btn-xs btn-default" href="http://localhost:8080/jobSkillBracket/account/edit-company.php?company=<?php echo $column[0]; ?>">Edit</a>
                                                <form method="POST" class="delete-form" action="" onsubmit="return confirm('Are you sure you want to delete this case?');">
                                                    <input type="hidden" name="company_id" value="<?php echo $column[0]; ?>">
                                                    <input type="hidden" name="jeg_action" value="delete-company">
                                                    <input type="hidden" name="jobplanet_nonce" value="5000a3a329">
                                                    <input type="submit" class="btn btn-theme btn-xs btn-default  btn-danger" name="Delete" value="Delete">
                                                </form>
                                ...
                                <nav>
                                    <ul class="pagination pagination-theme no-margin ">
                                       <?php
											if($_GET['page']!=1){ ?>
										<li><a class="prev page-numbers" data-page="<?php echo $_GET['page']-1; ?>" href="http://localhost:8080/jobSkillBracket/account/manage-company.php?page=<?php echo $_GET['page']-1; ?>">←</a></li> 
										<?php }
										for($i=0;$i<$pages;$i++){ 
											if($_GET['page']==($i+1)){ ?>
												...
												?>
										<li><a class="page-numbers" data-page="<?php echo ($i+1); ?>" href="http://localhost:8080/jobSkillBracket/account/manage-company.php?page=<?php  echo ($i+1); ?>"><?php echo ($i+1); ?></a></li><?php
											}
										...
										if($_GET['page']!=round($pages)){
											?>
										<li><a class="next page-numbers" data-page="<?php echo $_GET['page']+1; ?>" href="http://localhost:8080/jobSkillBracket/account/manage-company.php?page=<?php echo $_GET['page']+1; ?>">→</a></li>
										<?php
										}
										?>
