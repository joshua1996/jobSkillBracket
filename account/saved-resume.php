...
<nav class="navbar navbar-default main-navbar hidden-sm hidden-xs">
    <div class="container">
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul id="menu-primary" class="nav navbar-nav"><li id="menu-item-154" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-154"><a href="http://jobplanet.jegtheme.com/job-list/">Find Job <span class="caret"></span></a></li>
<li id="menu-item-155" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-155"><a href="http://jobplanet.jegtheme.com/resume-list/">Find Resume <span class="caret"></span></a></li>
<li id="menu-item-156" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-156"><a href="http://jobplanet.jegtheme.com/create-vacancy/">Create Vacancy <span class="caret"></span></a></li>
...
<ul class="dropdown-menu" role="menu">
	<li id="menu-item-300" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-300"><a href="http://jobplanet.jegtheme.com/select-plan/">Select Plan <span class="caret"></span></a></li>
	<li id="menu-item-189" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-189"><a href="http://jobplanet.jegtheme.com/about-us/">About Us <span class="caret"></span></a></li>
	<li id="menu-item-206" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-206"><a href="http://jobplanet.jegtheme.com/contact/">Contact Us <span class="caret"></span></a></li>
	<li id="menu-item-207" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-207"><a href="http://jobplanet.jegtheme.com/term-of-service/">Term &amp; Privacy <span class="caret"></span></a></li>
	<li id="menu-item-198" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-198"><a href="http://jobplanet.jegtheme.com/blog/">Article &amp; Blog <span class="caret"></span></a></li>
	<li id="menu-item-464" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-464"><a href="http://jobplanet.jegtheme.com/company-listing/">Company Listing <span class="caret"></span></a></li>
	<li id="menu-item-161" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-161"><a href="http://jobplanet.jegtheme.com/404">Error 404 <span class="caret"></span></a></li>
	<li id="menu-item-208" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-208"><a href="http://jobplanet.jegtheme.com/shortcode/">Shortcode <span class="caret"></span></a></li>
</ul>
</li>
...
<li class="btn-highlight">
    ...
    <li class="link-btn"><a href="http://jobplanet.jegtheme.com/wp-login.php?action=logout&amp;redirect_to=http%3A%2F%2Fjobplanet.jegtheme.com%2Faccount%2F&amp;_wpnonce=0b92bcf249"><span class="btn btn-theme  btn-pill btn-xs btn-line">Logout</span></a></li>
</ul>
        </div>
    </div>
</nav>
...
<li class="btn-highlight">
    <a href="http://jobplanet.jegtheme.com/account/create-company/" class="btn-highlight">
        Create Company    </a>
</li>                    <li class="btn-highlight"><a href="http://jobplanet.jegtheme.com/wp-login.php?action=logout&amp;redirect_to=http%3A%2F%2Fjobplanet.jegtheme.com%2Faccount%2F&amp;_wpnonce=0b92bcf249">Logout</a></li>
                </ul>
                    </li>
    </ul>
        ...
        <div class="mobile-nav-block">
            ...
            <a href="#" class="btn-nav-toogle">
                ...
                Close            </a>
            <ul id="menu-primary-1" class="nav navbar-nav"><li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-154"><a href="http://jobplanet.jegtheme.com/job-list/">Find Job <span class="caret"></span></a></li>
...
<h3 class="no-margin-top">Saved Resume</h3>
<p><strong>Note :</strong> Access your favorite resumes more easily</p>
<hr>
<div class="table-responsive">
            ...
            <tbody>
                                ...
                                <tr>
                        <th scope="row">1</th>
                        <td><a target="_blank" href="http://jobplanet.jegtheme.com/resume/senior-ux-designer/">Senior UX Designer</a></td>
                        <td>Julia Haney</td>
                        <td class="text-center">
                            <form action="" method="post">
                                <input type="hidden" name="resume_id" value="233">
                                <input type="hidden" name="jeg_action" value="remove-resume">
                                <input type="hidden" name="jobplanet_nonce" value="5000a3a329">
                                <input type="submit" class="btn btn-theme btn-xs btn-default" value="Remove Resume">
                            </form>
                        </td>
                    </tr>
                                        <tr>
                        <th scope="row">2</th>
                        <td><a target="_blank" href="http://jobplanet.jegtheme.com/resume/senior-quantity-surveyor/">Senior Quantity Surveyor</a></td>
                        <td>Albert Cruz</td>
                        <td class="text-center">
                            <form action="" method="post">
                                <input type="hidden" name="resume_id" value="231">
                                <input type="hidden" name="jeg_action" value="remove-resume">
                                <input type="hidden" name="jobplanet_nonce" value="5000a3a329">
                                <input type="submit" class="btn btn-theme btn-xs btn-default" value="Remove Resume">
                            </form>
                                        ...
                                        <tr>
                        <th scope="row">3</th>
                        <td><a target="_blank" href="http://jobplanet.jegtheme.com/resume/business-analyst-product-control/">Business Analyst &amp; Product Control</a></td>
                        <td>Clarence Savage</td>
                        <td class="text-center">
                            <form action="" method="post">
                                <input type="hidden" name="resume_id" value="227">
                                <input type="hidden" name="jeg_action" value="remove-resume">
                                <input type="hidden" name="jobplanet_nonce" value="5000a3a329">
                                <input type="submit" class="btn btn-theme btn-xs btn-default" value="Remove Resume">
                            </form>
            ...
            <ul class="pagination pagination-theme no-margin ">
                <li><span class="page-numbers current">1</span></li><li><a class="page-numbers" data-page="2" href="http://jobplanet.jegtheme.com/account/saved-resume/page/2/">2</a></li><li><a class="next page-numbers" data-page="2" href="http://jobplanet.jegtheme.com/account/saved-resume/page/2/">→</a></li>            </ul>
        </nav>
                </div>
    ...
    JobPlanet - Responsive JobBoard WordPress Themes. Quisque eget lacus turpis. Curabitur ac pretium felis, vel lobortis leo. Praesent quis mi viverra, sodales mi id, dapibus tortor. Mauris sed venenatis dui. Aliquam sed convallis erat.     </div>
                                                        ...
                                                        <div class="col-sm-4">
                                <div class="footer-widget-content widget widget_nav_menu" id="nav_menu-3"><h3 class="widget-title">Job by Location</h3><div class="menu-location-menu-container"><ul id="menu-location-menu" class="menu"><li id="menu-item-276" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-276"><a href="http://jobplanet.jegtheme.com/job-location/los-angeles/">Los Angeles, California</a></li>
...
<li id="menu-item-281" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-281"><a href="http://jobplanet.jegtheme.com/job-location/long-beach/">Long Beach, New York</a></li>
                                                        ...
                                                        <div class="col-sm-4">
                                <div class="footer-widget-content widget widget_tag_cloud" id="tag_cloud-3"><h3 class="widget-title">Tag Cloud</h3><div class="tagcloud"><a href="http://jobplanet.jegtheme.com/tag/assessment/" class="tag-link-153" title="1 topic" style="font-size: 8pt;">assessment</a>
                        ...
                        <div class="col-sm-6 ">
                            ...
                            <div class="socials text-right text-center-xs">
                                <a target="_blank" href="http://facebook.com/jegtheme">
                                    ...
                                    </a><a target="_blank" href="http://twitter.com/jegtheme">
                                        <i class="fa fa-twitter"></i>
                                    </a><a target="_blank" href="http://plus.google.com/+jegtheme">
...
/* <![CDATA[ */
var _wpcf7 = {"loaderUrl":"http:\/\/jobplanet.jegtheme.com\/wp-content\/plugins\/contact-form-7\/images\/ajax-loader.gif","recaptchaEmpty":"Please verify that you are not a robot.","sending":"Sending ..."};
/* ]]> */
</script>
...
<script type="text/javascript">
/* <![CDATA[ */
var joption = {"selectNotFound":"Oops, nothing found","deleteConfirm":"Are you sure want to Continue?","limitFile":"Exceed number of allowed file upload. Max file upload is ","adminurl":"http:\/\/jobplanet.jegtheme.com\/wp-admin\/admin-ajax.php","date_format":"F j, Y"};
/* ]]> */
</script>
...
<script type="text/javascript">
/* <![CDATA[ */
var woocommerce_params = {"ajax_url":"\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/account\/saved-resume\/?wc-ajax=%%endpoint%%"};
/* ]]> */
</script>
...
<script type="text/javascript">
/* <![CDATA[ */
var wc_cart_fragments_params = {"ajax_url":"\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/account\/saved-resume\/?wc-ajax=%%endpoint%%","fragment_name":"wc_fragments"};
/* ]]> */
</script>
...
<script type="text/javascript">
/* <![CDATA[ */
var jobplanetoption = {"isie":"","sharearticle":"Share Article","templateurl":"http:\/\/jobplanet.jegtheme.com\/wp-content\/themes\/jobplanet-themes","loading":"loading","jobBookmarked":"job bookmarked","failedBookmark":"failed to bookmark","alredyBookmark":"Job Already Bookmarked","resumeSaved":"resume saved","failedSaveResume":"failed to save resume","alredySavedResume":"Resume Already Saved","companyFollowed":"company followed","failedFollowCompany":"failed to follow company","alreadyFollowCompany":"Already Follow this Company","sending":"Sending","send":"Send","emailsent":"Email Sent","ajaxurl":"http:\/\/jobplanet.jegtheme.com\/wp-admin\/admin-ajax.php"};
/* ]]> */
</script>
