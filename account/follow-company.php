...
<body class="page page-id-12 page-template-default logged-in jobplanet wpb-js-composer js-comp-ver-4.9.1 vc_responsive">
        ...
        Create Job Alert    </a>
                    ...
                    <div class="col-md-9 col-sm-9">
                        <div class="block-section box-side-account">
                            ...
                            <h3 class="no-margin-top">Following Company</h3>
                            <p><strong>Note :</strong> By following this company, you can view their latest job vacancies in your dashboard</p>
                            <hr>
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <th scope="row">1</th>
                                            <td><a target="_blank" href="http://jobplanet.jegtheme.com/company/gold-fitness-gym/">Gold Fitness Gym</a></td>
                                            <td>
                                                Sport &amp; Recreation </td>
                                            <td class="text-right">
                                                <form action="" method="post">
                                                    <input type="hidden" name="company_id" value="265">
                                                    <input type="hidden" name="jeg_action" value="unfollow-company">
                                                    <input type="hidden" name="jobplanet_nonce" value="a854635412">
                                                    <input type="submit" class="btn btn-theme btn-xs btn-default" value="Unfollow">
                                                </form>
                                            </td>
                                        </tr>
                                    </tbody>
    ...
    <script type="text/javascript">
        ...
        var woocommerce_params = {
            ...
            "wc_ajax_url": "\/account\/follow-company\/?wc-ajax=%%endpoint%%"
        };
        /* ]]> */
    </script>
