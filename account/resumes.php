...
<ul class="dropdown-menu" role="menu">
    ...
    <li class="dropdown">
        <a href="http://jobplanet.jegtheme.com/account/" class="link-profile dropdown-toggle" data-toggle="dropdown">
            <img alt="" src="http://2.gravatar.com/avatar/285fdccd4aefdba27ddb2328eb80b604?s=80&amp;d=mm&amp;r=g" srcset="http://2.gravatar.com/avatar/285fdccd4aefdba27ddb2328eb80b604?s=160&amp;d=mm&amp;r=g 2x" class="avatar avatar-80 photo img-profile" height="80" width="80">             &nbsp;  <b class="caret"></b>
        </a>
                    <ul class="dropdown-menu" role="menu">
...
<li class="btn-highlight">
    ...
    <li class="link-btn"><a href="http://jobplanet.jegtheme.com/wp-login.php?action=logout&amp;redirect_to=http%3A%2F%2Fjobplanet.jegtheme.com%2Faccount%2F&amp;_wpnonce=b1033ffc12"><span class="btn btn-theme  btn-pill btn-xs btn-line">Logout</span></a></li>
</ul>
        </div>
    </div>
</nav>
...
<li class="btn-highlight">
    <a href="http://jobplanet.jegtheme.com/account/create-alert/">
        Create Job Alert    </a>
</li>                    <li class="btn-highlight"><a href="http://jobplanet.jegtheme.com/wp-login.php?action=logout&amp;redirect_to=http%3A%2F%2Fjobplanet.jegtheme.com%2Faccount%2F&amp;_wpnonce=b1033ffc12">Logout</a></li>
                </ul>
                    </li>
    </ul>
            ...
            <div class="container">
                <div class="col-md-3 col-sm-3">
                    ...
                    <div class="block-section text-center block-account-nav">
                        <img alt="" src="http://2.gravatar.com/avatar/285fdccd4aefdba27ddb2328eb80b604?s=128&amp;d=mm&amp;r=g" srcset="http://2.gravatar.com/avatar/285fdccd4aefdba27ddb2328eb80b604?s=256&amp;d=mm&amp;r=g 2x" class="avatar avatar-128 photo img-rounded" height="128" width="128">
    ...
    <a href="http://jobplanet.jegtheme.com/account/create-alert/">
        Create Job Alert    </a>
                        ...
                        <div class="list-unstyled"></div>
                                                    <a href="http://jobplanet.jegtheme.com/account/create-resume/" class="btn btn-theme btn-t-primary btn-block">
                                Create Resume                            </a>
                            <a href="http://jobplanet.jegtheme.com/account/create-alert/" class="btn btn-theme btn-t-primary btn-block">
                                Create Job Alert                            </a>
                                            </div>
                </div>
...
<h3 class="no-margin-top">My Resume</h3>
<p><strong>Note :</strong> Make applying easier by creating a predefined resume. The resume will also searchable by employers.</p>
<hr>
<div class="table-responsive">
            <div class="alert alert-info fade in" role="alert">
            You have not created any resumes yet        </div>
        </div>
...
<script type="text/javascript">
/* <![CDATA[ */
var woocommerce_params = {"ajax_url":"\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/account\/resumes\/?wc-ajax=%%endpoint%%"};
/* ]]> */
</script>
...
<script type="text/javascript">
/* <![CDATA[ */
var wc_cart_fragments_params = {"ajax_url":"\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/account\/resumes\/?wc-ajax=%%endpoint%%","fragment_name":"wc_fragments"};
/* ]]> */
</script>
