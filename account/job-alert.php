...
<h3 class="no-margin-top">Job Alert</h3>
<p><strong>Note :</strong> Create a job alert, receive emails about newly opened jobs vacancies every day</p>
<hr>
<div class="table-responsive">
            <div class="alert alert-info fade in" role="alert">
            You have not created any job alerts yet        </div>
        </div>
...
<script type="text/javascript">
/* <![CDATA[ */
var woocommerce_params = {"ajax_url":"\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/account\/job-alert\/?wc-ajax=%%endpoint%%"};
/* ]]> */
</script>
...
<script type="text/javascript">
/* <![CDATA[ */
var wc_cart_fragments_params = {"ajax_url":"\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/account\/job-alert\/?wc-ajax=%%endpoint%%","fragment_name":"wc_fragments"};
/* ]]> */
</script>
