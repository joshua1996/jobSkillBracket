...
<body class="page page-id-12 page-template-default logged-in jobplanet wpb-js-composer js-comp-ver-4.9.1 vc_responsive">
    ...
    <div class="wrapper">
                ...
                <div class="container">
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul id="menu-primary" class="nav navbar-nav">
                            <li id="menu-item-154" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-154"><a href="http://jobplanet.jegtheme.com/job-list/">Find Job <span class="caret"></span></a></li>
        ...
        Create Job Alert    </a>
                                ...
                                <li class="btn-highlight"><a href="http://jobplanet.jegtheme.com/wp-login.php?action=logout&amp;redirect_to=http%3A%2F%2Fjobplanet.jegtheme.com%2Faccount%2F&amp;_wpnonce=b1033ffc12">Logout</a></li>
                            </ul>
                        </li>
                    </ul>
        ...
        Create Job Alert    </a>
                    ...
                    <div class="col-md-9 col-sm-9">
                        <div class="block-section box-side-account">
                            ...
                            <h3 class="no-margin-top">Create Job Alert</h3>
                            <hr>
                            <form method="post" action="" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="title">Job Alert Title <span class="mandatory">*</span></label>
                                            <input id="title" name="title" placeholder="Title for your Job alert" type="text" class="form-control" value="">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="keyword">Keyword</label>
                                            <input id="keyword" name="keyword" placeholder="Keywords on jobs that might apply" type="text" class="form-control" value="">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="categories">Job Category </label>
                                            <select name="categories[]" multiple="" class="chosen-select form-control" data-placeholder="Category of your desired Job" style="display: none;">
                                            ...
                                            <div class="chosen-container chosen-container-multi" style="width: 764px;" title="">
                                                <ul class="chosen-choices">
                                                    <li class="search-field">
                                                        <input type="text" value="Category of your desired Job" class="default" autocomplete="off" style="width: 215px;">
                                                    </li>
                                                </ul>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="chosen-container chosen-container-single" style="width: 764px;" title="" id="location_chosen"><a class="chosen-single"><span>California</span><div><b></b></div></a>
                                                <div class="chosen-drop">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="type[]" multiple="" class="chosen-select form-control" data-placeholder="Job Type" style="display: none;">
                                                <option value="7">Contract</option>
                                                <option value="8">Freelance</option>
                                                <option value="9">Full Time</option>
                                                <option value="10">Part Time</option>
                                            </select>
                                            <div class="chosen-container chosen-container-multi" style="width: 764px;" title="">
                                                <ul class="chosen-choices">
                                                    <li class="search-field">
                                                        <input type="text" value="Job Type" class="default" autocomplete="off" style="width: 84px;">
                                                    </li>
                                                </ul>
                                                <div class="chosen-drop">
                                                    <ul class="chosen-results"></ul>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="frequency" class="chosen-select form-control" data-placeholder="Email Frequency" style="display: none;">
                                                <option value="daily">Daily</option>
                                                <option value="weekly">Weekly</option>
                                                <option value="fortnight">Fortnight</option>
                                                <option value="monthly">Monthly</option>
                                            </select>
                                            <div class="chosen-container chosen-container-single" style="width: 764px;" title=""><a class="chosen-single"><span>Daily</span><div><b></b></div></a>
                                                <div class="chosen-drop">
                                                    <div class="chosen-search">
                                                        <input type="text" autocomplete="off">
                                                    </div>
                                ...
                                <div class="form-group">
                                    <input type="hidden" name="jeg_action" value="create-alert">
                                    <input type="hidden" name="jobplanet_nonce" value="a854635412">
                                    <input type="submit" class="btn btn-theme btn-t-primary btn-block-xs" value="Create Job Alert">
                                </div>
                            </form>
    ...
    <script type="text/javascript">
        ...
        var woocommerce_params = {
            ...
            "wc_ajax_url": "\/account\/create-alert\/?wc-ajax=%%endpoint%%"
        };
        /* ]]> */
    </script>
