...
<body class="page page-id-15 page-template-default jobplanet wpb-js-composer js-comp-ver-4.9.1 vc_responsive">
...
<div class="container">
    <nav class="mobile-nav hidden-md hidden-lg">
        ...
        <li class="link-btn"><a href="http://jobplanet.jegtheme.com/account/login/"><span class="btn btn-theme btn-xs btn-line">Login</span></a></li>
                    <li class="link-btn"><a href="http://jobplanet.jegtheme.com/account/register/"><span class="btn btn-theme btn-xs btn-line">Register</span></a></li>
            </ul>
...
</div>    <div class="bg-color5 block-section">
        <div class="container">
...
<div class="alert alert-info fade in" role="alert">
        Applicant Role user : <strong>demo-applicant</strong> <br>
        Employer Role user : <strong>demo-employer</strong> <br>
        Password : <strong>password</strong><br>
    </div>
<!-- form login -->
<form id="jeg_form_login" class="jeg_form" action="" method="post">
    ...
    <div class="form-group no-margin">
        <input type="hidden" name="redirect" value="http://jobplanet.jegtheme.com/create-vacancy/package/">
        <input type="hidden" name="jeg_action" value="login">
        <input type="hidden" name="role" value="employer">
        <input type="hidden" name="jobplanet_nonce" value="5b75ec5724">
        <input type="submit" class="btn btn-theme btn-lg btn-t-primary btn-block" value="Log In">
    </div>
</form>
<!-- form login -->                        </div>
                    </div>
            ...
            <div class="white-space-20"></div>
                ...
                <a href="http://jobplanet.jegtheme.com/create-vacancy/register/"><strong>Create a free account</strong></a>
            </div>
                    </div>
    </div>
...
<script type="text/javascript">
/* <![CDATA[ */
var woocommerce_params = {"ajax_url":"\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/create-vacancy\/login\/?wc-ajax=%%endpoint%%"};
/* ]]> */
</script>
...
<script type="text/javascript">
/* <![CDATA[ */
var wc_cart_fragments_params = {"ajax_url":"\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/create-vacancy\/login\/?wc-ajax=%%endpoint%%","fragment_name":"wc_fragments"};
/* ]]> */
</script>
